...
const Searchbar = () => {
  return (
    <>
      <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl top-2 z-index-sticky shadow-none bg-dark" id="navbarBlur" data-scroll="true">
            ...
            <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
              ...
              <ul className="navbar-nav  justify-content-end">
                ...
                <li className="nav-item d-xl-none ps-3 d-flex align-items-center">
                  <a href="" className="nav-link p-0 text-white" id="iconNavbarSidenav">
                      ...
                      <a className="dropdown-item border-radius-md" href="">
                        <div className="d-flex py-1">
                          ...
                          <div className="d-flex flex-column justify-content-center">
                            ...
                            <p className="text-xs mb-0 text-white opacity-8">
